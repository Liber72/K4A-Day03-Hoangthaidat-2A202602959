...
def run_react_agent(user_query: str, provider, mcp_server: MCPFinanceServer) -> list:
    ...
    # Augmented prompt: tích lũy observation qua các bước để LLM suy luận tiếp
    ...
    while step < MAX_ITERATIONS:
        ...
        # Trường hợp 2: LLM đề xuất gọi Tool (Action)
            ...
            if not obs_data:
                ...
                # Nạp observation trở lại prompt để LLM suy luận bước tiếp theo
                augmented_prompt += (
                ...
                # Tiếp tục vòng lặp → LLM sẽ tự quyết định gọi tool tiếp hay trả lời final
...
if __name__ == "__main__":
    print("==========================================================")
    print("📈 FINANCE ASSISTANT - DAY 03 LAB: CHATBOT VS REACT AGENT")
    print("==========================================================")
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Câu hỏi chung: 'Chỉ số P/E là gì và ý nghĩa trong phân tích cổ phiếu?'")
        print("   - Tra cứu cổ phiếu: 'Hãy tra cứu thông tin tài chính của cổ phiếu FPT'")
        print("   - Đặt lệnh: 'Hãy đặt lệnh mua 100 cổ phiếu VNM với giá 75000 đồng'")
        print("   - Gõ 'exit' hoặc 'quit' để kết thúc phiên trò chuyện.\n")
        while True:
            try:
                user_input = input("👤 Nhà đầu tư hỏi: ").strip()
        ...
        print(f"--- 🏁 DEMO CHẠY THỬ 1 TEST CASE MẪU (TC02: Tra cứu cổ phiếu) ---")
